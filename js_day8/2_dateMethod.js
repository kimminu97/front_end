...
//날짜 지정 : 년도,월,일(단, 월은 0~11입니다.)
console.log(new Date(2002,05,01))   //Sat Jun 01 2002 00:00:00 GMT+0900 (대한민국 표준시) 5->6월
//날짜 시간 지정 : 년도,월,일,시,분,초
console.log(new Date(2022,02,16,9,30,25)) //Wed Mar 16 2022 09:30:25 GMT+0900 (3월)
//getTime 메소드 : 1970년 1월1일 기준으로 지나온 시간을 ms단위로 계산하여 리턴 - 타임스탬프(timestamp)
...
console.log(today.getMonth())   //3월 -> 2
...
console.log(today)
today.setFullYear(today.getFullYear()-2)    // 2년전
console.log(today)
...
//출생일에서 3000일 기념일
let mybirth = new Date(1997,6,22) //내 생일 : 1997년 7월 22일
console.log('나의 생일 : '+mybirth)
mybirth.setDate(mybirth.getDate()+3000)
console.log('탄생 3000일 기념일 : '+ mybirth)

//실기문제 : 오늘날짜를 년도 4자리, 월 2자리, 일 2자리
...
//필요한 값으로 배열을 만들고 join메소드로 연결시켜 문자열을 생성(연결기호는 없으므로'')
console.log([year,month2,date2].join(''))   //20220317
console.log([year,month2,date2].join('-'))  //2022-03-17
//join : 배열 -> 문자열로 , split : 문자열 -> 배열로

console.log(new Date('2022-03-03'))
console.log(new Date('2022-03-05')-new Date('2022-03-02'))  //결과는 타임스탬프(timestamp)값
let diff = new Date('2022-03-05')-new Date('2022-03-02')
